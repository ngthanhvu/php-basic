            ...
            <body>
                <div class="container">
                    ...
                    <form action="update.php" method="POST">
                        ...
                        <div class="form-group">
                            <label for="picture">Thoi Luong:</label>
                            <input type="number" class="form-control" id="picture" name="year" placeholder="Điền thời lượng mới" value="<?php echo $movies['year'] ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="picture">Link mp3:</label>
                            <input type="text" class="form-control" id="picture" name="linkvideo" placeholder="Điền link mp3 mới" value="<?php echo $movies['linkvideo'] ?>">
                        </div>
