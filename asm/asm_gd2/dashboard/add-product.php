...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
     ...
     if (isset($connection)) {
          try {
               $query = "INSERT INTO product (name,picture,price) VALUES (:name, :picture, :price)";
     ...
     <div class="container">
          ...
          <form action="add-product.php" method="POST">
               ...
               <div class="mb-3">
                    ...
                    <textarea class="form-control" id="price" name="price" rows="4" ></textarea>
                    <?php
                    if (isset($errors['price'])) {
                         echo "<span style='color:red;'> Error: " .$errors['price'] . "</span>";
                    }
                    ?>
               </div>
